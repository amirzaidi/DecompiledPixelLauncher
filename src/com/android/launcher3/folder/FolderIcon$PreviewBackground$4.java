...
final class FolderIcon$PreviewBackground$4 implements Runnable
{
    ...
    FolderIcon$PreviewBackground$4(final FolderIcon$PreviewBackground this$1, final CellLayout val$cl, final int val$cellX, final int val$cellY) {
        this.this$1 = this$1;
        this.val$cl = val$cl;
