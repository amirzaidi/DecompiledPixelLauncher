...
final class PreviewBackground$8 implements Runnable
{
    ...
    PreviewBackground$8(final PreviewBackground this$0, final CellLayout val$cl, final int val$cellX, final int val$cellY) {
        this.this$0 = this$0;
        this.val$cl = val$cl;
