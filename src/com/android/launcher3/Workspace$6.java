...
final class Workspace$6 implements LayoutTransition$TransitionListener
{
    final /* synthetic */ Workspace this$0;
    
    Workspace$6(final Workspace this$0) {
        this.this$0 = this$0;
    }
    ...
    public void endTransition(final LayoutTransition layoutTransition, final ViewGroup viewGroup, final View view, final int n) {
        if (!layoutTransition.isRunning()) {
            this.this$0.mIgnoreQsbScroll = false;
            layoutTransition.removeTransitionListener((LayoutTransition$TransitionListener)this);
            this.this$0.mFirstPageScrollX = this.this$0.getScrollForPage(0);
            this.this$0.onWorkspaceOverallScrollChanged();
        }
    }
    ...
    public void startTransition(final LayoutTransition layoutTransition, final ViewGroup viewGroup, final View view, final int n) {
        this.this$0.mIgnoreQsbScroll = true;
    }
}
