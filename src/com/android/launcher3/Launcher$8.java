...
final class Launcher$8 implements Runnable
{
    ...
    Launcher$8(final Launcher this$0, final int val$appWidgetId, final PendingRequestArgs val$requestArgs, final AppWidgetHostView val$layout, final int val$resultCode) {
        this.this$0 = this$0;
