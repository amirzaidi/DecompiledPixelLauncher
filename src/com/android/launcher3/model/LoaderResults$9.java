...
final class LoaderResults$9 implements Runnable
{
    final /* synthetic */ LoaderResults this$0;
    final /* synthetic */ LauncherAppWidgetInfo val$widget;
    
    LoaderResults$9(final LoaderResults this$0, final LauncherAppWidgetInfo val$widget) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (launcherModel$Callbacks != null) {
            launcherModel$Callbacks.bindAppWidget(this.val$widget);
        }
    }
}
