...
public class PageIndicatorCaretLandscape extends PageIndicator
{
    ...
    public PageIndicatorCaretLandscape(final Context context, final AttributeSet set, final int n) {
        super(context, set, n);
        final int dimensionPixelSize = context.getResources().getDimensionPixelSize(2131427396);
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        canvas.translate((float)((this.getWidth() - bounds.width()) / 2), (float)(this.getHeight() - bounds.height()));
