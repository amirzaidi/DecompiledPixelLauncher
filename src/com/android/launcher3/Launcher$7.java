...
final class Launcher$7 implements Runnable
{
    ...
    Launcher$7(final Launcher this$0, final int val$resultCode, final int val$appWidgetId, final PendingRequestArgs val$requestArgs, final CellLayout val$dropLayout) {
        this.this$0 = this$0;
