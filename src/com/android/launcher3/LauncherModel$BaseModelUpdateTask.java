...
public abstract class LauncherModel$BaseModelUpdateTask implements Runnable
{
    ...
    void init(final LauncherModel mModel) {
        this.mModel = mModel;
    ...
    public void run() {
        ...
        this.execute(this.mModel.mApp, LauncherModel.sBgDataModel, this.mModel.mBgAllAppsList);
    }
    
    public final void scheduleCallbackTask(final LauncherModel$CallbackTask launcherModel$CallbackTask) {
        this.mUiHandler.post(new LauncherModel$BaseModelUpdateTask$1(this, this.mModel.getCallback(), launcherModel$CallbackTask));
    }
}
