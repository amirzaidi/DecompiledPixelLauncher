...
final class Workspace$13 implements Runnable
{
    ...
    Workspace$13(final Workspace this$0, final CellLayout$CellInfo val$dragInfo, final View val$target, final DropTarget$DragObject val$d, final boolean val$isFlingToDelete, final boolean val$success) {
        this.this$0 = this$0;
