...
{
    public static final String cz(final Context context) {
        ...
        while (true) {
            try {
                ...
                if (TextUtils.isEmpty(charSequence)) {
                    charSequence = context.getString(2131493010);
                }
                return context.getString(2131493011, new Object[] { charSequence });
            }
    ...
    public void onInitializeAccessibilityNodeInfo(final View view, final AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (((NexusLauncherActivity)Launcher.getLauncher(view.getContext())).fg()) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo$AccessibilityAction(2131493011, (CharSequence)cz(view.getContext())));
        }
    }
    
    public boolean performAccessibilityAction(final View view, final int n, final Bundle bundle) {
        if (n == 2131493011) {
            ((NexusLauncherActivity)Launcher.getLauncher(view.getContext())).fh();
            return true;
        }
