...
public class c
{
    ...
    public d aN(final long p0, final int p1) {
        // 
        ...
        //     1: monitorenter   
        //     2: aload_0        
        //     3: getfield        com/google/android/apps/nexuslauncher/reflection/c/c.bD:Lcom/google/android/apps/nexuslauncher/reflection/c/b;
        //     6: astore          4
        //     8: aload           4
        //    10: invokevirtual   com/google/android/apps/nexuslauncher/reflection/c/b.getReadableDatabase:()Landroid/database/sqlite/SQLiteDatabase;
        //    13: astore          4
        ...
        //   265: astore          10
        //   267: aload           10
        //   269: invokestatic    com/google/android/apps/nexuslauncher/reflection/a/a.am:([B)Lcom/google/android/apps/nexuslauncher/reflection/a/a;
        //   272: astore          10
        //   274: aload           21
        //   276: aload           10
        //   278: invokespecial   com/google/android/apps/nexuslauncher/reflection/b/b.<init>:(Lcom/google/android/apps/nexuslauncher/reflection/a/a;)V
        //   281: aload           12
        //   283: iload           19
        ...
        //   292: aload           21
        //   294: aload           10
        //   296: invokevirtual   com/google/android/apps/nexuslauncher/reflection/b/b.aJ:(Ljava/lang/String;)Lcom/google/research/reflection/a/b;
        //   299: pop            
        //   300: aload           12
        //   302: iload           17
        ...
        //   325: astore          10
        //   327: aload           10
        //   329: invokestatic    com/google/android/apps/nexuslauncher/reflection/a/e.ao:([B)Lcom/google/android/apps/nexuslauncher/reflection/a/e;
        //   332: astore          10
        //   334: new             Lcom/google/android/apps/nexuslauncher/reflection/b/a;
        //   337: astore          27
        //   339: aload           27
        //   341: aload           10
        //   343: invokespecial   com/google/android/apps/nexuslauncher/reflection/b/a.<init>:(Lcom/google/android/apps/nexuslauncher/reflection/a/e;)V
        //   346: aload           21
        //   348: aload           27
        //   350: invokestatic    com/google/research/reflection/common/b.Un:(Lcom/google/research/reflection/a/b;Lcom/google/research/reflection/a/a;)V
        //   353: aload           12
        //   355: iload           23
        ...
        //   378: astore          10
        //   380: aload           10
        //   382: invokestatic    com/google/android/apps/nexuslauncher/reflection/a/e.ao:([B)Lcom/google/android/apps/nexuslauncher/reflection/a/e;
        //   385: astore          10
        //   387: new             Lcom/google/android/apps/nexuslauncher/reflection/b/a;
        //   390: astore          27
        //   392: aload           27
        //   394: aload           10
        //   396: invokespecial   com/google/android/apps/nexuslauncher/reflection/b/a.<init>:(Lcom/google/android/apps/nexuslauncher/reflection/a/e;)V
        //   399: aload           21
        //   401: aload           27
        //   403: invokestatic    com/google/research/reflection/common/b.Un:(Lcom/google/research/reflection/a/b;Lcom/google/research/reflection/a/a;)V
        //   406: aload           5
        //   408: aload           21
    ...
    public void aO(final long n) {
        synchronized (this) {
            ...
            this.bD.getWritableDatabase().delete("reflection_event", "timestamp <= ?", new String[] { Long.toString(n - 3024000000L) });
        }
    }
    
    public void aP(final com.google.research.reflection.a.b b) {
        synchronized (this) {
            this.aR(((com.google.android.apps.nexuslauncher.reflection.b.b)b).ay());
        }
    }
    
    public void aQ(final String p0, final String p1, final Map p2) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //     8: aload_0        
        //     9: getfield        com/google/android/apps/nexuslauncher/reflection/c/c.bD:Lcom/google/android/apps/nexuslauncher/reflection/c/b;
        //    12: astore          5
        //    14: aload           5
        //    16: invokevirtual   com/google/android/apps/nexuslauncher/reflection/c/b.getWritableDatabase:()Landroid/database/sqlite/SQLiteDatabase;
        //    19: astore          5
        //    21: aload           5
    ...
    public void aR(final a a) {
        ...
        Block_11_Outer:
            while (true) {
                ...
                try {
                    Preconditions.assertNonUiThread();
                    try {
                        final byte[] byteArray = com.google.protobuf.nano.a.toByteArray(a);
                        Label_0272: {
                            try {
                                am = a.am(byteArray);
                                writableDatabase = this.bD.getWritableDatabase();
                                ...
                                return;
                                // iftrue(Label_0333:, !o.aN.equals((Object)"semantic_place"))
                                while (true) {
        ...
        am.av = ((List<byte[]>)s2).toArray(new e[((List)s2).size()]);
        contentValues.put("proto", com.google.protobuf.nano.a.toByteArray(am));
