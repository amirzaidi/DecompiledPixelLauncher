...
public class d implements SearchAlgorithm, Handler$Callback
{
    ...
    public d(final Context mContext) {
        this.mContext = mContext;
        this.mUiHandler = new Handler((Handler$Callback)this);
        if (d.fJ == null) {
            (d.fJ = new HandlerThread("search-thread", -2)).start();
        }
        this.fI = new Handler(d.fJ.getLooper(), (Handler$Callback)this);
    }
    
    private void er(final e p0) {
        // 
        ...
        //    21: astore_3       
        //    22: aload_1        
        //    23: getfield        com/google/android/apps/nexuslauncher/search/e.fL:Ljava/lang/String;
        //    26: astore          4
        //    28: aload_3        
        //    29: aload           4
        ...
        //    39: astore          4
        //    41: aload_0        
        //    42: getfield        com/google/android/apps/nexuslauncher/search/d.mContext:Landroid/content/Context;
        //    45: astore_3       
        //    46: aload_3        
        ...
        //    99: ifeq            180
        //   102: aload_1        
        //   103: getfield        com/google/android/apps/nexuslauncher/search/e.fM:Ljava/util/ArrayList;
        //   106: astore          6
        //   108: aload           4
        //   110: iload           9
        ...
        //   124: astore          7
        //   126: aload_0        
        //   127: getfield        com/google/android/apps/nexuslauncher/search/d.mContext:Landroid/content/Context;
        //   130: astore          8
        //   132: aload           7
        //   134: aload           8
        //   136: invokestatic    com/google/android/apps/nexuslauncher/search/AppSearchProvider.es:(Landroid/net/Uri;Landroid/content/Context;)Lcom/android/launcher3/util/ComponentKey;
        //   139: astore          7
        //   141: aload           6
        //   143: aload           7
        ...
        //   230: athrow         
        //   231: aload_0        
        //   232: getfield        com/google/android/apps/nexuslauncher/search/d.mUiHandler:Landroid/os/Handler;
        //   235: sipush          200
        //   238: aload_1        
    ...
    public void doSearch(final String s, final AllAppsSearchBarController$Callbacks allAppsSearchBarController$Callbacks) {
        final int n = 100;
        this.fI.removeMessages(n);
        Message.obtain(this.fI, n, (Object)new e(s, allAppsSearchBarController$Callbacks)).sendToTarget();
    }
    ...
    public boolean handleMessage(final Message message) {
        ...
        switch (message.what) {
            ...
            case 100: {
                this.er((e)message.obj);
                return b;
            }
            case 200: {
                final e e = (e)message.obj;
                e.fK.onSearchResult(e.fL, e.fM);
                return b;
            }
        }
    }
