...
# instance fields
.field private acC:Landroid/app/Notification$Builder;

.field private acD:Ljava/util/List;

.field private acE:Landroid/widget/RemoteViews;

.field private acF:Landroid/widget/RemoteViews;

.field private acG:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/aW;->acD:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/aW;->acC:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/aW;->acG:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/aW;->acF:Landroid/widget/RemoteViews;

    .line 98
    move-object/from16 v0, p25

    iput-object v0, p0, Landroid/support/v4/app/aW;->acE:Landroid/widget/RemoteViews;
    ...
    .line 77
    :cond_5
    iget-object v4, p0, Landroid/support/v4/app/aW;->acG:Landroid/os/Bundle;
    ...
    .line 80
    iget-object v5, p0, Landroid/support/v4/app/aW;->acG:Landroid/os/Bundle;
...
.method public aim(Landroid/support/v4/app/S;)V
    ...
    .prologue
    .line 103
    iget-object v0, p0, Landroid/support/v4/app/aW;->acD:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/aW;->acC:Landroid/app/Notification$Builder;
...
.method public ain()Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 108
    iget-object v0, p0, Landroid/support/v4/app/aW;->acC:Landroid/app/Notification$Builder;
...
.method public build()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/aW;->acG:Landroid/os/Bundle;
    ...
    .line 122
    iget-object v1, p0, Landroid/support/v4/app/aW;->acF:Landroid/widget/RemoteViews;

    if-nez v1, :cond_1

    .line 125
    :goto_1
    iget-object v1, p0, Landroid/support/v4/app/aW;->acE:Landroid/widget/RemoteViews;
