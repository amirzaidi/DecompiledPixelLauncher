...
# instance fields
.field private Ye:Landroid/app/Notification$Builder;

.field private Yf:Landroid/widget/RemoteViews;

.field private Yg:I

.field private Yh:Landroid/widget/RemoteViews;

.field private Yi:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;I)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/K;->Ye:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/K;->Yi:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/K;->Yh:Landroid/widget/RemoteViews;

    .line 96
    move-object/from16 v0, p25

    iput-object v0, p0, Landroid/support/v4/app/K;->Yf:Landroid/widget/RemoteViews;

    .line 97
    move/from16 v0, p26

    iput v0, p0, Landroid/support/v4/app/K;->Yg:I
    ...
    .line 89
    :cond_5
    iget-object v4, p0, Landroid/support/v4/app/K;->Yi:Landroid/os/Bundle;
    ...
    .line 92
    iget-object v5, p0, Landroid/support/v4/app/K;->Yi:Landroid/os/Bundle;
...
.method private alm(Landroid/app/Notification;)V
    .locals 1
...
.method public aim(Landroid/support/v4/app/S;)V
    ...
    .prologue
    .line 102
    iget-object v0, p0, Landroid/support/v4/app/K;->Ye:Landroid/app/Notification$Builder;
...
.method public build()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/K;->Yi:Landroid/os/Bundle;
    ...
    .line 114
    iget-object v1, p0, Landroid/support/v4/app/K;->Yh:Landroid/widget/RemoteViews;

    if-nez v1, :cond_1

    .line 117
    :goto_0
    iget-object v1, p0, Landroid/support/v4/app/K;->Yf:Landroid/widget/RemoteViews;

    if-nez v1, :cond_2

    .line 121
    :goto_1
    iget v1, p0, Landroid/support/v4/app/K;->Yg:I
    ...
    .line 132
    invoke-direct {p0, v0}, Landroid/support/v4/app/K;->alm(Landroid/app/Notification;)V
